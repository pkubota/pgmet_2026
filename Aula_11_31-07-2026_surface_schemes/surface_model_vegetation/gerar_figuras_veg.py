...
if __name__ == "__main__":
    ...
    figura_forcantes(forc, "/mnt/user-data/outputs/veg_fig1_forcantes.png")
    figura_balanco_hidrico(forc, hist, p, "/mnt/user-data/outputs/veg_fig2_balanco_hidrico.png")
    figura_energia(forc, hist, "/mnt/user-data/outputs/veg_fig3_balanco_energia.png")
    figura_resistencias(forc, hist, "/mnt/user-data/outputs/veg_fig4_resistencias.png")
