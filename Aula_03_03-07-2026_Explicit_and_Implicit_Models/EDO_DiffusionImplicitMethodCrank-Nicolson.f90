...
! END DO 
 ...
 !     ____                               ____   __         __                                                                       |
 !    |                                       | |             |                                                                      |
 !x=0 |  0            0      0         0      | | a(t+1,0  )  | =   C a(t  ,0) + 2(1 -C) a(t,1)  + C a(t  ,2)                        |
 !x=1 | 2(1 + C)     -C      0        -C      | | a(t+1,1  )  | =   C a(t  ,1) + 2(1 -C) a(t,2)  + C a(t  ,3) <------------------------
 !x=2 | -C       2(1 + C)   -C         0      | | a(t+1,2  )  | =   C a(t  ,2) + 2(1 -C) a(t,3)  + C a(t  ,4) 
 !x=3 |  0           -C   2(1 + C)    -C      | | a(t+1,3  )  | =   C a(t  ,3) + 2(1 -C) a(t,4)  + C a(t  ,5) 
 !x=4 | -C            0     -C      2(1 + C)  | | a(t+1,4  )  | =   C a(t  ,4) + 2(1 -C) a(t,5)  + C a(t  ,6) 
 !x=5 |  0            0      0         0      | | a(t+1,i+1)  | =   
 !    |____                               ____| |__         __|
 !
 !                 A                                X         =     B
 !
...
CONTAINS
 ...
 SUBROUTINE InitClass_WritetoGrads()
    IMPLICIT NONE
   FileName=''
   FileName='ImplicitLinearDiffusion1DMethodCrankNicolson'
...
!     a (i)= - C 
  ...
  DO i=1,ninteraction
        ...
        DO ii =ilo,ihi
              B    (ii-1)  = coef_C* A(ii-1) + 2*(1.0_r8 - coef_C)*A(ii)  + coef_C*A(ii+1)
        END DO 
         Anew (ilo:ihi)  = 0.0_r8
